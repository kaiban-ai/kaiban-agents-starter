...
describe('kaiban_activity data part handling', () => {
  it('Airport Services Advisor agent listens to kaiban_activity without error and completes', async () => {
    const params = {
      message: {
    ...
    const client = await createClientFromServer(baseUrl, '/agents/airportServices/a2a');
