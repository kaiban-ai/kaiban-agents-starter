...
function getOurAgentId(): string | null {
  return process.env.KAIBAN_GROUP_BOOKING_QUOTE_AGENT_ID || process.env.KAIBAN_AGENT_ID || null;
}
...
export const groupBookingQuoteAgentExecutor = new GroupBookingQuoteAgentExecutor();
